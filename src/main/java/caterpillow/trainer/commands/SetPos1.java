...
public class SetPos1 extends CommandBase {
    @Override
    ...
    public String getCommandUsage(ICommandSender iCommandSender) {
        return "Sets the position of the first coordinate of whatever ur trying to do.";
    }
    ...
    public void processCommand(ICommandSender iCommandSender, String[] strings) throws CommandException {
        ...
        if (mop.typeOfHit.equals(MovingObjectPosition.MovingObjectType.BLOCK)) {
            ...
            AimTrainer.instance.commandManager.pos1 = mop.getBlockPos();

            Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("Pos1 set to " + mop.getBlockPos().getX() + ", " + mop.getBlockPos().getY() + ", " + mop.getBlockPos().getZ()));
        } else {
